...
ACTIVITY_REGISTRY = [
    ...
    },
    {
        ...
        "icon": "⛏️",
        "description": "Gather world-map resources with adaptive menu/manual anti-detect logic",
        "weight": "heavy",
        "steps": [
            {"function_id": "startup_to_lobby", "config": {}},
        ...
        "config_fields": [
            ...
            },
            {
                ...
                "label": "Shuffle Rotation (Legacy Rotation Only)",
                "type": "checkbox",
                "default": False,
            },
            {
                "key": "legion_1_resource",
                "label": "Legion 1 Resource (Manual Mode Plan)",
                "type": "select",
            ...
            },
            {
                ...
                "label": "Legion 2 Resource (Manual Mode Plan)",
                "type": "select",
                "options": ["wood", "stone", "gold", "mana", "skip"],
                "default": "wood",
            },
            {
                ...
                "label": "Legion 3 Resource (Manual Mode Plan)",
                "type": "select",
                "options": ["wood", "stone", "gold", "mana", "skip"],
                "default": "wood",
            },
            {
                ...
                "label": "Legion 4 Resource (Manual Mode Plan)",
                "type": "select",
                "options": ["wood", "stone", "gold", "mana", "skip"],
                "default": "wood",
            },
            {
                ...
                "label": "Legion 5 Resource (Manual Mode Plan)",
                "type": "select",
                "options": ["wood", "stone", "gold", "mana", "skip"],
                "default": "wood",
            },
